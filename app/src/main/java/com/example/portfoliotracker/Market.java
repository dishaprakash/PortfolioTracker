...
public class Market extends AppCompatActivity {
    ...
    private Button addAssetsButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addAssetsButton = (Button) findViewById(R.id.addAssetButton);
        addAssetsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openAddAssetsPage();
            }
